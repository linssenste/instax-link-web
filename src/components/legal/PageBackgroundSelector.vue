<template>
    <div class="ml-0 d-flex flex-row align-center">
        ...
        <div v-on:click="selectedColor='yellow'" :class="selectedColor==='yellow'? 'color-selector-item-selected':''"
            data-testid="yellow-color-selector-item" class="color-selector-item bg-yellow rounded-pill "></div>
        <div v-on:click="selectedColor='green'" :class="selectedColor==='green'? 'color-selector-item-selected':''"
            data-testid="green-color-selector-item" class="color-selector-item bg-green rounded-pill "></div>
        <div v-on:click="selectedColor='indigo'" :class="selectedColor==='indigo'? 'color-selector-item-selected':''"
            data-testid="indigo-color-selector-item" class="color-selector-item bg-indigo rounded-pill "></div>
